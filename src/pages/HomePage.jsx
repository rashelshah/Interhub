      ...
      <section className="py-20 bg-gradient-to-b from-gray-50 to-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold mb-4 text-gray-900">Featured Opportunities</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {featuredInternships.map((internship) => (
              <InternshipCard 
                ...
                internship={{
                  ...internship,
                  salary: `₹${internship.salary.replace('$', '')}`,
                  location: internship.location.replace(/US states/g, 'India').replace(/, [A-Z]{2}$/, '')
                }} 
              />
            ))}
          </div>
            ...
            {[
              ...
              >
                <div className="flex flex-col items-center text-center">
                  <div className="mb-4 p-4 rounded-full bg-teal-100 group-hover:bg-teal-200 transition-colors">
                    {category.icon}
                  </div>
